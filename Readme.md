...
- These open tabs will be labeled "untitled". Fixed in MuseScore 2.0+ and not an issue anymore with MuseScore 1.2+
...
The idea for this plugin stems from a [question in the forum] (http://musescore.org/en/node/12452).
